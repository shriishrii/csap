...
const QString BITCOIN_IPC_PREFIX("csap:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click csap: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start csap: click-to-pay handler");
    else
...
{
    // clicking on csap: URLs creates FileOpen events on the Mac:
