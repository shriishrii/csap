    ...
    QSplashScreen(pixmap, f)
{
    ...
    //QString copyrightText   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The BTC Dev. - 2016 CSAP"));
	QString copyrightText = QChar(0xA9) + QString(" (2016 CSAP) 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The BTC Dev."));
